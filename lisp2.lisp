...
(print (APL-APPLY '(f1 f1 f1 f2 f2) '(1 2 3 (1 2 3) (1 2 3 4)))) ;(26 27 28 6 10) 
...
(print(некоторый #'numberp '(1 2 3 5 7)));T
(print(некоторый #'numberp '(A B)));NIL
...
(print(удалить-если-не #'numberp '(1 A 3 B 5 6 7)))  ;(1 3 5 6 7)
...
(defun многофун (f x)
    (mapcar #'(lambda (f) (apply f x)) f) 
)

(print(многофун '(+ -) '(1 2))) ;(3 -1) 
